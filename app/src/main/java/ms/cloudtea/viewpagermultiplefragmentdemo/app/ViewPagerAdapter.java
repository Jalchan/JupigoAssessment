...
import ms.cloudtea.viewpagermultiplefragmentdemo.app.frags.Tab2Fragment;
import ms.cloudtea.viewpagermultiplefragmentdemo.app.frags.Tab3Fragment;

/**
 * Created by Jal on 7/19/17.
 */
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                result = new Tab1Fragment();
                break;
            case 1:
                // First Fragment of Second Tab
                result = new Tab2Fragment();
                break;
            case 2:
                // First Fragment of Third Tab
                result = new Tab3Fragment();
                break;
            default:
                result = null;
                break;
